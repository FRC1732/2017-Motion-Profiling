...
import org.usfirst.frc.team1732.robot.subsystems.motionprofile.MotionProfileManager;
...
public class Drivetrain extends Subsystem {
	...
	public void startMotionProfile(Trajectory left, Trajectory right) {
		leftManage.setTrajectory(left);
		rightManage.setTrajectory(right);
		executeMotionProfile();
		leftManage.startMotionProfile();
		rightManage.startMotionProfile();
	}
	...
	public void executeMotionProfile() {
		...
		leftMaster.set(leftManage.getSetValue().value);
		rightMaster.set(rightManage.getSetValue().value);
