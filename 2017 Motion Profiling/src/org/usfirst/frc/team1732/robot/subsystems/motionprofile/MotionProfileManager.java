...
public class MotionProfileManager {
	...
	private void startFilling(Trajectory traj) {
		...
		for (int i = 0; i < traj.length(); ++i) {
			...
			point.position = Drivetrain.inchesToRev(traj.get(i).position);
			point.velocity = Drivetrain.inchesToRev(traj.get(i).velocity);
			point.timeDurMs = (int) (traj.get(i).dt * 1000);
